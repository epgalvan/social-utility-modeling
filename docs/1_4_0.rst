...
.. dropdown:: Propose a :bdg-warning:`Utility` Equation
    ...
    :bdg-warning-line:`Difference in Utility for Alternative, Compared to Default` = 
    ( :bdg-success-line:`κ` × **LM** × :bdg-secondary-line:`Payout`) + ((1 - :bdg-success-line:`κ` ) × **LS** × :bdg-secondary-line:`Harm`)
