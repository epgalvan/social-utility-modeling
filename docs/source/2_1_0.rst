...
.. dropdown:: Preallocating and Defining Functions
    ...
    .. tab-set::
            ...
            .. tab-item:: Plain English
                ...
                3. :bdg-secondary:`Utility` Function - this should be a function of :bdg-secondary:`Construct Value` and :bdg-success:`Free Parameters`
                ...
                1. A list of all subject folders/files that tell us which data to retrieve for analysis - these must include the subject ID to be able to be identifyied
...
.. dropdown:: Recover :bdg-success-line:`Free Parameters`

    .. tab-set::

            .. tab-item:: Plain English

                Now, we are going to answer the Determine Free Parameters demand placed on us in the :bdg-success:`Subject` loop, namely to recover :bdg-success-line:`Free Parameters`.
                We only need to hand our Objective Function the :bdg-success:`Subject`'s data. 
                ...
                .. dropdown:: And what do we want to finish with?
                    ...
                    1. A single set of :bdg-success:`Free Parameters`
                    2. The Model Error for your :bdg-success:`Free Parameters`
            ...
            .. tab-item:: R
                ...
                ::
                    ...
                    for (i in 1:length(included_subjects)){
                        ...
                        model_NLL = -2 * sum(dnorm(observed, mean = #Determine Predictions))
                        model_SS = sum((df$Decision - #Determine Predictions)**2)
                        ...
                        trialData[start:end, 5] = #Determine Predictions
                    }
...
.. dropdown:: Determine Predicted :bdg-danger:`Decisions` for these :bdg-success-line:`Free Parameters`
    ...
    .. tab-set::
            ...
            .. tab-item:: Plain English
                ...
                We have found the :bdg-success:`Subject`'s :bdg-success-line:`Free Parameters` so we need to specifically know what it is that our model predicts that they will do.
