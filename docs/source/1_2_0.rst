...
To create an experimental paradigm where every potential answer to that research question should have a distinguishable behavioral trend over the course of the experiment which enables you to differentiate between other psychological accounts. 
