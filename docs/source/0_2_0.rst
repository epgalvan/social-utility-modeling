...
.. dropdown::  Implication 1: *If* Desire to Maximize Subjective Utility :octicon:`arrow-right;2em` Decision, *Then* Subjective Utility (Decision) = max(Subjective Utility ([Decision Set]))  
