...
.. dropdown:: Examples of :bdg-warning:`Utility` Equations
    ...
    .. Note:: 
        Adh is shorthand for Adherance and Vio is shorthand for Violation. 
    ...
    .. dropdown:: :bdg-warning:`Utility` = ( :bdg-secondary:`Payout Adh` × :bdg-success:`Θ` ) + (1 - :bdg-success:`Θ` ) × 

    .. dropdown:: :bdg-warning:`Utility` = ( :bdg-secondary:`Payout Adh` × :bdg-success:`Θ` ) + 
