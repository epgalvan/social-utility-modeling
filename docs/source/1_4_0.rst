...
.. dropdown:: Examples of :bdg-warning:`Utility` Equations
    ...
    .. dropdown:: :bdg-warning:`Utility` = ( :bdg-secondary:`Payout_Maximization` × :bdg-success:`Θ` ) + (1 - :bdg-success:`Θ` ) × (:bdg-success:`Φ` × :bdg-secondary:`Norm 1 Adherance`  + (1 - :bdg-success:`Φ` ) × :bdg-secondary:`Norm 2 Adherance` )
