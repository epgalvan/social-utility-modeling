...
.. dropdown:: Conceptual Examples of :bdg-secondary:`construct value` Formulations
    ...
    * Could also use min
    * The second argument (0 here) can be anything
    ...
    * If smaller norm violations are more significant than a linear relationship would suggest
    ...
    .. Note::
        ...
        <Any Kind of> Norm Adherance = 1 - <That Same Kind of> Norm Violation
...
.. dropdown:: Examples of :bdg-warning:`Utility` Equations
    ...
    .. Note:: 
        Adh is shorthad for Adherance and Vio is shorthad for Violation.

    1 Parameter

    2 Parameters 

    .. dropdown:: :bdg-warning:`Utility` = ( :bdg-secondary:`Payout Adh` × :bdg-success:`Θ` ) + (1 - :bdg-success:`Θ` ) × (:bdg-success:`Φ` × :bdg-secondary:`Norm 1 Adh`  + (1 - :bdg-success:`Φ` ) × :bdg-secondary:`Norm 2 Adh` )

    .. dropdown:: :bdg-warning:`Utility` = ( :bdg-secondary:`Payout_Maximization` × :bdg-success:`Θ` ) - (1 - :bdg-success:`Θ` ) × 

    .. dropdown:: :bdg-warning:`Utility` = ( :bdg-secondary:`Payout_Maximization` × :bdg-success:`Θ` ) + (1 - :bdg-success:`Θ` ) × 

    .. dropdown:: :bdg-warning:`Utility` = ( :bdg-secondary:`Payout_Maximization` × :bdg-success:`Θ` ) + 
