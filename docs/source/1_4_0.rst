    ...
    .. dropdown:: Greed
        ...
        .. tab-set::
            ...
            .. tab-item:: Plain English
                ...
                Since :bdg-danger:`Keep` can range from 0 to :bdg-primary-line:`Investment` × :bdg-primary-line:`Multiplier`, it ranges from 0 to 1, inclusive.
    ...
    .. dropdown:: Inequity Aversion
        ...
        .. tab-set::
            ...
            .. tab-item:: Plain English
                ...
                In the Trust Game, the Trustee's payout is what they :bdg-danger:`Keep` which is ( :bdg-primary-line:`Investment` × :bdg-primary-line:`Multiplier` ) - :bdg-danger:`Returned` 
                while the Investor's payout is what they did not invest which is ( :bdg-primary-line:`Endowment` - :bdg-primary-line:`Investment`). 
                If the Trustee has half of the money in the game, :bdg-danger:`Keep` is half of all of the money in the game - 
                ...
                :bdg-secondary:`Inequity` = (0.5 - ( :bdg-danger:`Keep`/( :bdg-primary-line:`Endowment` - :bdg-primary-line:`Investment` + :bdg-primary-line:`Investment` × :bdg-primary-line:`Multiplier` )))²

                Since :bdg-danger:`Keep` can range from 0 to :bdg-primary-line:`Investment` × :bdg-primary-line:`Multiplier` (when :bdg-primary-line:`Endowment` - :bdg-primary-line:`Investment` = 0), the maximum difference can be 0.5 which when squared is 0.25. 
                Thus, :bdg-secondary:`Inequity` can range from 0 to 0.25, inclusive.
        ...
        .. tab-set::
            ...
            .. tab-item:: Plain English
                ...
                .. Note::
                    ...
                    Of course this seems unreasonable but let's play this out further - (( :bdg-primary-line:`Investment` × :bdg-primary-line:`Believed Multiplier` )/2) - :bdg-danger:`Returned` can actually be equal to :bdg-primary-line:`Investment` × :bdg-primary-line:`Believed Multiplier`. 
                    This could be very problematic: :bdg-secondary:`Guilt` can only range from 0 to 0.25 but :bdg-secondary:`Guilt` can range from 0 to 1. 
                    ...
                    .. dropdown:: What's a reasonable alternative formulation?
                        ...
                        The answer would be to apply a unidirectional formulation: max(((( :bdg-primary-line:`Investment` × :bdg-primary-line:`Believed Multiplier` )/2) - :bdg-danger:`Returned` ), 0)
                ...
                :bdg-secondary:`Guilt` = (((( :bdg-primary-line:`Investment` × :bdg-primary-line:`Believed Multiplier` )/2) - :bdg-danger:`Returned` ) /( :bdg-primary-line:`Investment` × :bdg-primary-line:`Believed Multiplier` )/( :bdg-primary-line:`Investment` × :bdg-primary-line:`Believed Multiplier` ))²
...
.. dropdown:: Identify which :bdg-success:`free parameters` are relevant for each :bdg-secondary:`construct value` in determining :bdg-warning:`Utility`
    ...
    1. :bdg-secondary:`Payout Maximization` - :bdg-success:`D1`  
    2. :bdg-secondary:`Equity Achieved` - :bdg-success:`D1` & :bdg-success:`D2` 
    3. :bdg-secondary:`Expectation Meeting` - :bdg-success:`D1` & :bdg-success:`D2` 
...
.. dropdown:: Identify how each :bdg-secondary:`construct value` mathematically interacts with the relevant :bdg-success:`free parameters` to determine :bdg-warning:`Utility`
    ...
    :bdg-warning:`Utility` = :bdg-secondary:`Payout_Maximization` × :bdg-success:`Θ`  - (1 - :bdg-success:`Θ` ) × min( :bdg-secondary:`Guilt` +  :bdg-success:`Φ` , :bdg-secondary:`Inequity` -  :bdg-success:`Φ` )
