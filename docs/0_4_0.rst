...
.. dropdown:: Choosing a Tutorial
    ...
    4. `Li et al., 2022`_ - this looked at competing social motives within a person in a binary choice task (data for `Tutorial 1`_ available here)
