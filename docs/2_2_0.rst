...
.. dropdown:: Select a Model Fit Index
    ...
    Therefore, you should use AIC for generalized models (models without :bdg-success:`Free Parameters` characterizing the actual Decision-Making Process such as noise, bias, or stochastic selection (i.e. inverse heat) :bdg-success:`Free Parameters`)
